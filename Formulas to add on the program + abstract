...
wij = fijlog(N/ nj ) : this formulas allows us to calculate the similarity beteen produced lyrics and all verses from the same arist. Here, N is the nomber of all the verses, nj is the number of verses containing term j and fij is the freuency of term j in the ith verse : this formulas allows us to calculate the cosine distance between verses, being a measure of similary. The more the score obtained is low, the more novel are the lyrics (Peter Potash, Alexey Romanov, Anna Rumshisky)
